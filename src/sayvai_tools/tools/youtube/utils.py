...
def import_googleapiclient_resource_builder() -> build_resource:
    ...
    try:
        ...
        raise ImportError(
            "You need to install google-api-python-client to use this toolkit. "
            "Try running pip install --upgrade google-api-python-client"
        )
    return build


DEFAULT_SCOPES = ["https://www.googleapis.com/auth/youtube", "https://www.googleapis.com/auth/youtube.force-ssl",
