...
def build_forms_service(
    ...
    service_name: str = "forms",
    service_version: str = "v1",
) -> Resource:
    """Build a Forms service."""
    credentials = credentials or get_forms_credentials()
