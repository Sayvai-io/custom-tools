...
class UpdateSpreadsheetSchema(BaseModel):
    ...
    spreadsheet_id: str = Field(..., description="ID of the spreadsheet to update.")
    range_: str = Field(
...
class UpdateSpreadsheetTool(GoogleSheetsBaseTool):
    ...
    description: str = (
        "Use this tool to update cell values in a specified range of a Google Sheets spreadsheet."
    )
