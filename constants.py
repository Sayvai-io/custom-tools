...
agent: invoke calendar tool to schedule meeting with sanjay pranav
...
###(example)###
user: schedule a meeting with sanjay pranav tomorrow at 10pm for 1 hour
agent: invoke datetime tool 
agent: invoke calendar tool with input (tomorrow's date,22,00/tomorrow's date,22,45/email)to schedule meeting with sanjay pranav
agent: meeting scheduled with sanjay pranav
                       """)
